...
Adapted from 'IGNN <https://github.com/SwiftieH/IGNN>'_
    and from 'GPRGNN <https://github.com/jianhao2016/GPRGNN/>'_
Optimizer: Adam
Loss: NLL
...
class Model(Module):
    def __init__(self, in_channels, hidden_channels, out_channels, dropout, alpha, gamma, K):
        super(Model, self).__init__()
        self.lin1 = Linear(in_channels, hidden_channels)
        self.lin2 = Linear(hidden_channels, out_channels)

        self.prop1 = GPR_prop(K, alpha, 'Random', gamma)
...
@hydra.main(version_base=None, config_path="/root/workspace/PR-inspired-aggregation/baselines/gprgnn/", config_name="synth_chains.yaml")
def run_chains(cfg):
    ...
    wandb.init(entity='utah-math-data-science',
                ...
                mode=mode,
                name='gprgnn'+str(cfg.data['chain_len']),
                dir='/root/workspace/out/',
                tags=['synth-chains', 'gprgnn', str(cfg.data['chain_len'])],
