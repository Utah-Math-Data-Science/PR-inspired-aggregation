...
class Model(Module):
    def __init__(self,
        ...
        lin_module = CayleyLinear(in_channels, hidden_channels, num_nodes, invMethod='direct', adj=adj, device='cuda')
        nonlin_module = ReLU()
...
@hydra.main(version_base=None, config_path="/root/workspace/PR-inspired-aggregation/baselines/mignn/", config_name="synth_chains.yaml")
def run_chains(cfg):
