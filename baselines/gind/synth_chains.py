...
def load(cfg):
    ...
    model_kwargs['iter_nums'] = [model_kwargs['iter_num_1'],model_kwargs['iter_num_2']]
    del model_kwargs['iter_num_1']
    del model_kwargs['iter_num_2']
    model = GIND(
...
@hydra.main(version_base=None, config_path="/root/workspace/PR-inspired-aggregation/baselines/gind/", config_name="synth_chains.yaml")
def run_chains(cfg):
    ...
    wandb.init(entity='utah-math-data-science',
                ...
                mode=mode,
                name='gind-multi-class'+str(cfg.data['chain_len']),
                dir='/root/workspace/out/',
                tags=['synth-chains', 'gind', str(cfg.data['chain_len'])],
