...
class Model(Module):
    def __init__(self,
        ...
        self.gcn = GCN(in_channels, hidden_channels, hidden_layers, out_channels, dropout, normalize=False)
...
@hydra.main(version_base=None, config_path="/root/workspace/PR-inspired-aggregation/baselines/gcn/", config_name="synth_chains.yaml")
def run_chains(cfg):
    ...
    wandb.init(entity='utah-math-data-science',
                ...
                mode=mode,
                name='gcn-multi-class-100-9'+str(cfg.data['chain_len']),
                dir='/root/workspace/out/',
                tags=['synth-chains', 'gcn', str(cfg.data['chain_len'])],
